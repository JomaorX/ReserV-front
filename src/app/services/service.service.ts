...
export class ServiceService{
  ...
  createService(name: string, description: string, price: number, duration: number) {
    return this.http.post(this.apiUrl, { name, description, price, duration }, { headers: this.headers });
  }

  // Actualizar un servicio
  updateService(id: number, name: string, description: string, price: number, duration: number) {
    return this.http.put(`${this.apiUrl}/${id}`, { name, description, price, duration }, { headers: this.headers });
  }
